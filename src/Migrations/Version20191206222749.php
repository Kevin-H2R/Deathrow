 ...
 */
final class Version20191206222749 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `constraint` CHANGE item_id item_id INT DEFAULT NULL, CHANGE value value INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `constraint` CHANGE item_id item_id INT DEFAULT NULL, CHANGE value value SMALLINT NOT NULL');
        $this->addSql('ALTER TABLE effect CHANGE item_id item_id INT DEFAULT NULL');
